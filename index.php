    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu"> 
       <li> <a href="location map/hyderabad.html">Hyderabad</a></li>
      <li>  <a href='location map/chennai.html'>Chennai</a></li>
       <li> <a href="location map/vijaywada.html">Vijaywada</a></li>
      <li>  <a href="location map/tirupathi.html">Tirupathi</a></li>
     <li>   <a href='location map/coimbatore.html'>Coimbatore</a></li>
     <li>   <a href='location map/ongole.html'>Ongole</a></li>
     <li>   <a href='location map/guntur.html'>Guntur</a></li>
     <li>   <a href='location map/kerala.html'>Kerala</a></li>
        </ul>
        </li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="pic/Doctor_Time12.jpg" alt="img1" width="1200" height="700">

      </div>

      <div class="item">
        <img src="pic/A3.jpg" alt="img2" width="1200" height="700">
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px"  id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px"></i>Coimbatore,Tamil Nadu<br>
